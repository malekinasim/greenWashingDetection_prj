    ...
    def extract_images(self):
        ...
        for page_index in pages_to_process:
            ...
            for img in page.get_images(full=True):
                ...
                min_width = page_width * 0.05
                min_height = page_height * 0.05
                ...
                image_path =f"{dir_path}\\{self.processor.company}_{self.processor.year}_p{page_index+1}_i{img_index}.{base_image['ext']}"
